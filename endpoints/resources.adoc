...
|Certificate
|*22.08*
|The certificate resources represent the installed certificates used for stronger outgoing authentication and connections.
...
|Group
|*22.08*
|The ASUP resources represent the Astra groups and associated resources. Only LDAP groups are available in the current release.
...
|AppMirror
|*22.08*
|The ASUP resources represent the AppMirror resources to provide for the management of application mirroring relationships.
