...
|Package
|*22.04*
|The package resources provide registration and access to package definitions. Software packages consist of various components such as files, images, and other artifacts.
...
|Upgrade
|*22.04*
|The upgrade resources provide access to software components and the ability to initiate system upgrades.
