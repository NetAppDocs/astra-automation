...
keywords:
summary: You can list the available clusters in a specific cloud.
---
...
Perform the workflow link:../workflows_infra/wf_list_clouds.html[List the clouds] and select the cloud containing the clusters.
