...
summary: 'List the execution hook override resources for an app'
---
...
|items
|array[Any of: link:#executionHookOverride_1_0_get_response_body[executionHookOverride_1.0_get_response_body], array[]]
|True
a|
