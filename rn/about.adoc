...
Updates to Astra Control Service and Astra Control Center generally occur at the same time. However, in the past, Astra Control Service had an accelerated release cadence. This resulted in one or more incremental updates beyond the most recent Astra Control Center release.
...
Because this site documents the REST API for both deployment models, there may be some features only available with one or the other. Any significant differences between the two deployment models are noted as needed.
...
* https://docs.netapp.com/us-en/astra-control-center/[Astra Control Center 23.07 documentation^]
* https://docs.netapp.com/us-en/astra-control-service/[Astra Control Service 23.07 documentation^]
