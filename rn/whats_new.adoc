...
keywords: what's new, enhancements, new features
summary: NetApp periodically updates the Astra Control REST API to bring you new features, enhancements, and bug fixes.
---
