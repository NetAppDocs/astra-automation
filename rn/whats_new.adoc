...
This release includes a minor update of the REST API.

=== Enhanced execution hooks functionality

When using execution hooks, you can now add filters to control which containers a hook will match. If you create multiple filters for a single execution hook, they are combined with a logical AND operator. You can have up to 10 active filters per execution hook.
