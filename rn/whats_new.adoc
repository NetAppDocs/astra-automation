...
The new task endpoints provide access to managed task resources and can be used to displays the status of long-running tasks.
...
Multiple account subscriptions can be used for each of the cloud providers.
