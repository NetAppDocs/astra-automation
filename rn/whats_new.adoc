...
Three new resources types have been added: *apiResource*, *ldapGroup*, *ldapUser*, and *task*. In addition, the versions of several existing resources have been updated.
