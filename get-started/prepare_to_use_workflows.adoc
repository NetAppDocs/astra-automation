...
summary: You should be familiar with the organization and format of the Astra workflows before using them with a live deployment.
---
...
[NOTE]
The curl samples in the workflows use the URL for Astra Control Service. You need to change the URL when using the on-premises Astra Control Center as appropriate for your environment.
...
You can use these workflows after you have a managed cluster. Management workflows focus on application protection and support operations such as backing up, restoring, and cloning an app.
...
. Press *ENTER* to perform the following tasks:
